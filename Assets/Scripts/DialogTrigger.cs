            ...
            else
            {
                List<MultipleChoice> questions = new List<MultipleChoice>
                {
                    ...
                    new MultipleChoice(0, "What about something more tangible?", 2, new Dictionary<string, Message[]>
                    {
                        ...
                        {"There was a document.", new Message[] {new Message(0, "Go on.", interrogatorSoundPath + "go_on"), new Message(1, "It seems William declined a big offer for the farm recently.")}}
